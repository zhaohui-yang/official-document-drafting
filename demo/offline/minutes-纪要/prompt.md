...
- 正文固定行距：580 twips / 29pt
- 标题行距：580 twips / 29pt
- 版头后距：290 twips / 14.5pt
- 发文字号后距：290 twips / 14.5pt
- 标题后距：580 twips / 29pt
- 主送机关后距：580 twips / 29pt
- 落款前距：1740 twips / 87pt
- 正文首行缩进：2 字符
- 备注：正文固定行距 580 twips，约 29.00pt，更接近 225mm 版心下每面 22 行的推导值。
- 备注：标题、主送机关后距按 1 行控制，版头和发文字号后距按半行控制，正文与落款之间默认空 3 行。
...
## 用户任务说明
根据会议材料整理一份关于小狗“刀盾”网络传播热度情况的专题会议纪要，写清会议认为、会议决定、责任分工和后续要求；会议元信息不足时保留占位符。
