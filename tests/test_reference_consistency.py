"""docs/references/ 与 prompts/ 主源的一致性守卫测试。

目的：docs/references/ 下的说明文档是手工维护的面向读者文档，容易与 prompts/core
...
class ReferenceConsistencyTests(unittest.TestCase):
    def test_references_declare_prompts_core_as_source(self) -> None:
        for name in ("style-rules.md", "layout-rules.md", "font-usage.md", "document-types.md"):
            text = (REPO_ROOT / "docs" / "references" / name).read_text(encoding="utf-8")
    ...
    def test_official_standard_body_line_spacing_is_single_sourced(self) -> None:
        ...
        self.assertIn(
            "579",
            (REPO_ROOT / "docs" / "references" / "layout-rules.md").read_text(encoding="utf-8"),
            "docs/references/layout-rules.md 未与 official-standard 行距主源（579 twips）保持一致",
        )
    ...
    def test_document_types_lists_every_legal_doc_type(self) -> None:
        ...
        text = (REPO_ROOT / "docs" / "references" / "document-types.md").read_text(encoding="utf-8")
