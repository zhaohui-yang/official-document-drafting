...
- [adapters/offline/README.md](./adapters/offline/README.md)
- [adapters/offline/build.py](./adapters/offline/build.py)
- [dist/offline/default/system_prompt.md](./dist/offline/default/system_prompt.md)
...
- 正式产物：[dist/offline/default/system_prompt.md](./dist/offline/default/system_prompt.md)
...
- [prompts/doc-types/](./prompts/doc-types)
...
- [prompts/core/](./prompts/core)
- [prompts/doc-types/](./prompts/doc-types)
- [renderers/docx.py](./renderers/docx.py)
- [renderers/validate.py](./renderers/validate.py)
...
- [prompts/layout-profiles/](./prompts/layout-profiles)
- [prompts/font-profiles/](./prompts/font-profiles)
- [scripts/generate_docx.py](./scripts/generate_docx.py)
...
- [prompts/core/style.md](./prompts/core/style.md)
...
- [renderers/validate.py](./renderers/validate.py)
- [scripts/check_sections.py](./scripts/check_sections.py)
...
- [scripts/build_all.py](./scripts/build_all.py)
- [adapters/skill/build.py](./adapters/skill/build.py)
- [adapters/offline/build.py](./adapters/offline/build.py)
- [dist/](./dist)
