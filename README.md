...
- [adapters/webui/README.md](./adapters/webui/README.md)
- [adapters/webui/build.py](./adapters/webui/build.py)
- [dist/webui/default/system_prompt.md](./dist/webui/default/system_prompt.md)
...
- 正式产物：[dist/webui/default/system_prompt.md](./dist/webui/default/system_prompt.md)
