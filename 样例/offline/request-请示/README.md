...
4. 再使用完整提示词生成请示成稿，最后导出 `.docx`。

从当前 Markdown 成稿重新导出 `.docx`：

```bash
python3 src/renderers/docx.py \
  样例/offline/request-请示/20260404-关于申请开展“我的刀盾”传播案例梳理工作的请示-v01.md \
  -o 样例/offline/request-请示/20260404-关于申请开展“我的刀盾”传播案例梳理工作的请示-v01.docx \
  --doc-type 请示
```
